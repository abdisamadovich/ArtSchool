...
{
    public SchoolDto(int id, Language name, string address, string email, string siteLink, TimeSpan? workingHoursStart, TimeSpan? workingHoursEnd, DayOfWeek? workingDaysStart, DayOfWeek? workingDaysEnd, TimeSpan? lunchStart, TimeSpan? lunchEnd, int districtId, int regionId)
    {
        Id = id;
        Name = name;
        Address = address;
